...
import { Edit${moduleNamePascal}InputDto } from '../../usecases/edit-${moduleName}/dtos/edit-${moduleName}.dto';
...
export interface I${moduleNamePascal}Dao {
  ...
  edit(id: string, data: Edit${moduleNamePascal}InputDto): Promise<void>;
