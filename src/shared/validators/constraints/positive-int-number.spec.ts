...
describe('IsPositiveIntegerNumber', () => {
  ...
  beforeEach(() => {
    target = new IsPositiveIntegerNumber();
  });
  ...
  it('should return false when providing a boolean to value', () => {
    const result = target.validate(true);
