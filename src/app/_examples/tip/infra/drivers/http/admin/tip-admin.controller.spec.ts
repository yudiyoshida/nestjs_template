...
import { TipAdminController } from './tip-admin.controller';

// Veja arquivo `src/app/faq/infra/drivers/http/admin/faq-admin.controller.spec.ts`, confia.

describe('TipAdminController - Unit tests', () => {
  let sut: TipAdminController;
  ...
  beforeEach(async() => {
    const module = await Test.createTestingModule({
      ...
      controllers: [TipAdminController],
      providers: [
    ...
    sut = module.get(TipAdminController);
  ...
  describe('edit', () => {
    it('should call editTip.execute with id and body', async() => {
      ...
      // Act
      const result = await sut.edit(params, body);

      // Assert
      expect(result).toEqual(output);
      expect(editSpy).toHaveBeenCalledWith(params.id, body);
    });
  });
  ...
  describe('delete', () => {
    it('should call deleteTip.execute with id', async() => {
      ...
      // Assert
      expect(result).toEqual(output);
      expect(deleteSpy).toHaveBeenCalledWith(params.id);
    });
  });
});
